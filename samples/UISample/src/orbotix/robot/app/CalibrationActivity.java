 ...
 * <p>
 * Some of the layout elements can be customized by passing in resource identifiers for {@link android.graphics.drawable.Drawable} resources
 ...
 * </ul>
 * To use a custom title icon you can simply add the resource identifier to the extras bundle in the {@link android.content.Intent}
...
public class CalibrationActivity extends Activity implements CalibrationDialView.CalibrationEventListener {
	...
	/**
	 * Sets the background image of the {@link CalibrationActivity} to the {@link android.graphics.drawable.Drawable} found
	 * at the specified resource id.
	 *
	 * @see android.view.View#setBackgroundResource(int) latency warning for bigger drawables
	 * @param resourceId the resource identifier of the {@link android.graphics.drawable.Drawable}
	 */
	...
	/**
	 * Sets the title icon image of the {@link CalibrationActivity} to the {@link android.graphics.drawable.Drawable} found
	 * at the specified resource id.
	 *
	 * @see android.widget.ImageView#setImageResource(int) latency warning for bigger drawables
	 * @param resourceId the resource identifier of the {@link android.graphics.drawable.Drawable}
	 */
